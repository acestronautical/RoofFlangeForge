...
3. Fill in your roof numbers under **Roof** — rib width, indent widths, indent
   ...
   match a example ribbed sheet-metal roof, but any ribbed sheet-metal profile
...
- The **roof** is a periodic cross-section defined by `rib_width`,
  ...
  `sheet_thickness`. Defaults match the example ribbed sheet-metal roof; override
...
photo measurements of a example ribbed sheet-metal (see git history for the full
